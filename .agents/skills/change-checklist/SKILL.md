...
description: Pre-flight and post-flight checklist for any code or configuration change in the agent-toolkit repository. Use before declaring a task complete and before committing. Mention triggers - finished, ready to commit, done, verify, sanity check, definition of done.
---
